...
function NavBar({white,black,onClickFunc,clicked}) {
  ...
  return (
    ...
    <nav className={`mb-6 z-10 bg-white fixed flex items-center justify-between shadow shadow-gray-500 h-[52px] py-3 px-4 ${clicked === 'outer' ? ' ml-16 outer w-[calc(100vw-64px)]' : 'ml-64 w-[calc(100vw-256px)] inner'} max-sm:ml-16 max-sm:w-[calc(100vw-64px)]`}>
