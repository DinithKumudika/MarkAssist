...
function SubjectBox({subjectName,subjectCode,year,onClick,userType}) {
  ...
  return (
    <div className='h-24 w-56 mr-6 mb-8 rounded-lg z-20'>
      <div className='h-14 rounded-t-lg bg-[#00ADEF] flex justify-end pr-2 pt-2 z-20' >{userType==="admin" ? <MdEdit onClick={onClick} className='text-white hover:text-black z-30 w-6 h-6 hover:bg-blue-300 rounded-lg'/> : ""}</div>
