from fastapi import APIRouter, Body, Depends, HTTPException, Request, Response, status, UploadFile, File,Form
...
async def upload_files(request: Request, files: List[UploadFile] = File(...), text_data: str = Form(...)) -> JSONResponse:
